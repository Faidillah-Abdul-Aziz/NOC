            ...
            <div>
              ...
              <div className="update-input-group">
                ...
                <select className="update-input" name="Tipe Pekerjaan" value={formData["Tipe Pekerjaan"]} onChange={handleChange} required>
                  <option value="Aktivasi">Aktivasi</option><option value="Terminasi">Terminasi</option><option value="Upgrade">Upgrade</option><option value="Pergantian">Pergantian</option><option value="Cuti">Cuti</option>
                </select>
              </div>
              <div className="update-input-group">
